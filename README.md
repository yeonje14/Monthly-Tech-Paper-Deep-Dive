...
| Month | Track | Title (Original Source) | Key Takeaway & Insight (KR / EN) | Review Link | Reading Period | Status |
| :---: | :---: | :--- | :--- | :---: | :---: | :---: |
...
## 📝 Review Framework (작성 원칙)

### 1. Summary (핵심 요약)
> *What is the problem and the solution?*
* 논문이 해결하려는 **문제(Problem)**와 제안하는 **해결책(Solution)**을 3문장으로 요약.

### 2. Architecture & Logic (구조 분석)
> *How does it work?*
* 핵심 알고리즘이나 시스템 아키텍처를 **도식화**하거나 **수식/코드**로 설명.

### 3. Critique & Future Work (비판과 확장) ⭐
> *Research Potential*
* **Limit:** 이 논문의 한계점은 무엇인가? (예: 비용, 속도, 특정 상황에서의 에러)
* **Idea:** 나라면 이 문제를 어떻게 개선할 것인가? (대학원 진학을 위한 핵심 파트)
